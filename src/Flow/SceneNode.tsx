      ...
      <Flex direction="column" px={0}>
        ...
        <Stack gap="xs" px="xs">
          <DynamicTextField
            ...
            validate={value => isNotEmpty("Il nome della scena non può essere vuoto")(value) || (rfInstance.getNodes().some(node => node.data.label === value) ? "Esiste già un nodo con questo nome" : null)}
