...
/**
 * Small pop-up menu bound to a {@link Combobox} and a <{@link RichTextarea}/>.
 * 
 * Can show:
 * - No results
 * - Small list of mixed results
 * - Tabs with list of results for each {@link StoryElementType}
 * @param allElements items to search 
...
/**
 * Wrapper for {@link Combobox.Option} to serve as a clickable search result
 */
