...
/**
 * Wrapper for Mantine's {@link Modal} that allows populating the fields of a new {@link StoryElement}
 */
function ElementModal(props: {
	...
	const form = useForm({
		...
		validate: {
			name: value =>
				(isNotEmpty("Questo campo non può essere vuoto")(value) ??
				isNameAvailable(value, `Un ${StoryElementTypeDictionary.ita.singular[props.elementType]} con questo nome esiste già`))
		}
	});

	//Update Form's initialValues upon change of local initialValues
